...
public class NewUtilities {
    private static final String LOG_TAG = NewUtilities.class.getSimpleName();
    ...
    static String getBookInfo (String query)
    {
        ...
        try {
            Uri buildUri = Uri.parse(BOOK_URL).buildUpon().appendQueryParameter(PARAM, query)
                    .appendQueryParameter(LIMIT, "10").appendQueryParameter(PRINT_TYPE, "books").build();
